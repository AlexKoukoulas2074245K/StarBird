...
void main()
{
    ...
    frag_color = vec4(0.2f * noise_color.r * pow(distanceFromCenter, 5.0f), 0.2f * noise_color.r * pow(distanceFromCenter, 5.0f), noise_color.r * pow(distanceFromCenter, 5.0f), noise_color.r * pow(1.0f - distanceFromCenter, 5.0f));

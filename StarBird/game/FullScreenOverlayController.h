...
public:
    ...
    FullScreenOverlayController(Scene& scene, const float darkeningSpeed, const float maxDarkeningValue, CallbackType midwayCallback = nullptr, CallbackType completionCallback = nullptr);
